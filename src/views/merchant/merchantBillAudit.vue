  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('merchant.filter.billNo')" v-model="listQuery.title">
      </el-input>
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('merchant.filter.merchantName')" v-model="listQuery.title">
      </el-input>
      <el-select clearable class="filter-item" style="width: 130px" v-model="listQuery.type"
                 :placeholder="$t('merchant.filter.merchantType')">
        <el-option v-for="item in  calendarTypeOptions" :key="item.key" :label="item.display_name+'('+item.key+')'"
                   :value="item.key">
        </el-option>
      </el-select>
      <el-select clearable class="filter-item" style="width: 130px" v-model="listQuery.type"
                 :placeholder="$t('merchant.filter.checkStatus')">
        <el-option v-for="item in  calendarTypeOptions" :key="item.key" :label="item.display_name+'('+item.key+')'"
                   :value="item.key">
        </el-option>
      </el-select>
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('merchant.filter.goodsCode')" v-model="listQuery.title">
      </el-input>
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('merchant.filter.linkMan')" v-model="listQuery.title">
      </el-input>
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('merchant.filter.phone')" v-model="listQuery.title">
      </el-input>
      <el-button class="filter-item" type="primary" v-waves icon="el-icon-search" @click="handleFilter">
        {{$t('merchant.filter.search')}}
      </el-button>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit
      ...
      <el-table-column prop="billNo" align="center" :label="$t('merchant.table.billNo')" min-width="150px">
      </el-table-column>
      <el-table-column prop="merNum" :label="$t('merchant.table.merNum')" min-width="110" align="center">
      </el-table-column>
      <el-table-column prop="createUser" :label="$t('merchant.table.createUser')" min-width="130" align="center">
      </el-table-column>
      ...
      <el-table-column min-width="150" align="center" :label="$t('merchant.table.checkStatus')">
      ...
      <el-table-column prop="opType" align="center" :label="$t('merchant.table.opType')" :formatter="opType"
                       min-width="120">
      </el-table-column>
      <el-table-column align="center" :label="$t('merchant.table.actions')" min-width="230"
