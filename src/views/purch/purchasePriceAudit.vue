<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" border style="width: 100%;">
			...
			<el-table-column prop="createUser" label="创建人" width="120"  sortable>
			</el-table-column>
			...
			<el-table-column prop="dataType" label="操作类型" min-width="120" :formatter="formatdel" sortable>
			</el-table-column>
...
<script>
	...
	var purchasePriceAudit=require("../../mock/falseData/9_purchasePrice/1_purchasePriceAudit");
	export default {
		data() {
			return {
				filters: {
