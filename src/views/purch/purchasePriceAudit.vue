<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="批次号" v-model="listQuery.title">
      </el-input>
      <el-select clearable style="width: 130px" class="filter-item" v-model="listQuery.importance" placeholder="审核状态">
        <el-option v-for="item in importanceOptions" :key="item" label="审核状态" :value="item">
        </el-option>
      </el-select>
      <el-select clearable class="filter-item" style="width: 130px" v-model="listQuery.type" placeholder="操作类型">
        <el-option v-for="item in  calendarTypeOptions" :key="item.key" label="操作类型" :value="item.key">
        </el-option>
      </el-select>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column type="selection" width="55" align="center">
			...
			<el-table-column prop="dataType" label="操作类型" min-width="120" :formatter="formatdel" align="center">
			</el-table-column>
