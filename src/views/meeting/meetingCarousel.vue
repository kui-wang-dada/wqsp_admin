  ...
  <div>
    <div class="app-container calendar-list-container" v-show="addDialog">
      ...
      <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
        ...
        <el-table-column prop="oaName" align="center" label="标题区" width="100">
        </el-table-column>
        <el-table-column prop="title" label="标题区" width="130" align="center">
        </el-table-column>
        <el-table-column prop="meetingplaceType" label="标题区" width="120" :formatter="formatmet" align="center">
        </el-table-column>
        <el-table-column prop="redirectType" label="标题区" width="120" :formatter="formatred" align="center">
        </el-table-column>
        <el-table-column prop="startDate" label="标题区" min-width="180" :formatter="formatTime" align="center">
        </el-table-column>
        <el-table-column prop="endDate" label="标题区" min-width="180" :formatter="formatTimet" align="center">
        </el-table-column>
        <el-table-column prop="delFlag" label="标题区" min-width="90" :formatter="formatdel" align="center">
        </el-table-column>
        <el-table-column label="标题区" width="340" fixed="right" align="center">
