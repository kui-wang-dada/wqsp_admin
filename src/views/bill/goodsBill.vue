<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit
      ...
      <el-table-column align="center" :label="$t('bill.table.actions')" fixed="right" min-width="180"
...
<script>
  ...
  var datas = require("../../mock/falseData/2_goodsAdmin/addGoodsAdmin")
      ...
      return {
        ...
        addContent: {
          ...
          label: [
            ...
            {type: 0, label: "全称", width: "150"},
            {type: 1, label: '类别',width: "150", options: ['系统管理员', '录入员', '审核员', '测试员', '123']},
            {type: 0, label: '长（cm）',width: "100"},
            {type: 0, label: '宽（cm）',width: "100"},
            {type: 0, label: '高（cm）',width: "100"},
            {type: 1, label: '品牌',width: "100",options: ['系统管理员', '录入员', '审核员', '测试员', '123']},
            {type: 0, label: '毛重',width: "100"},
            {type: 0, label: '条码',width: "100"},
            {type: 0, label: '保质期',width: "100"},
            {type: 0, label: '基本单位',width: "100"},
            {type: 0, label: '备注',width: "100"},
            {type: 0, label: '小图',width: "100"},
            {type: 0, label: '主图',width: "100"},
            {type: 0, label: '详情图',width: "100"},
