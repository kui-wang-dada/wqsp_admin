<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="货主"
                v-model="listQuery.title">
      </el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit
      ...
      <el-table-column prop="updateDate" label="审核时间" min-width="150" align="center">
      </el-table-column>
