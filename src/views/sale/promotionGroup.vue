<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="billNo" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="merNum" label="标题区" min-width="150" :formatter="channel" align="center">
      </el-table-column>
      <el-table-column prop="createName" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="updateName" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="checkStatus" label="标题区" min-width="150" align="center">
      ...
      <el-table-column prop="createDate" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="updateDate" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="opType" label="标题区" min-width="150" :formatter="opType" align="center">
      </el-table-column>
...
var datas = require("../../mock/falseData/6_operate/12_promotionGroup")
