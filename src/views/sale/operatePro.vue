<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="运营区" v-model="listQuery.title">
      </el-input>
      <el-select clearable style="width: 130px" class="filter-item" v-model="listQuery.importance" placeholder="--促销类型--">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit highlight-current-row
      ...
      <el-table-column prop="oa_name" label="运营区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="promotion_type" label="促销类型" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="goods_no" label="商品编码" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="bar_code" label="商品条码" min-width="150"  align="center">
      </el-table-column>
      <el-table-column prop="goods_name" label="商品名称" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="sort" label="排序" min-width="150" align="center" >
      </el-table-column>
      ...
      <el-table-column label="清仓日期" min-width="150" align="center">
        <template slot-scope="scope">
