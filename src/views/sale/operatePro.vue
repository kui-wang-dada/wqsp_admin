<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="oa_name" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="promotion_type" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="goods_no" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="bar_code" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="goods_name" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="sort" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column label="标题区" min-width="150" align="center">
