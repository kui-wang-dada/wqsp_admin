	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0;">
			<el-form :inline="true" :model="filters" size="medium">
				...
				<el-form-item>
					<el-select v-model="filters.value1" placeholder="--促销类型--">
						<el-option
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" border
			...
			<el-table-column prop="oa_name" label="运营区" min-width="150">
			</el-table-column>
			<el-table-column prop="promotion_type" label="促销类型" min-width="150">
			</el-table-column>
			<el-table-column prop="goods_no" label="商品编码" min-width="150">
			</el-table-column>
			<el-table-column prop="bar_code" label="商品条码" min-width="150" >
			</el-table-column>
			...
			<el-table-column label="清仓日期" min-width="150" >
				<template slot-scope="scope">
