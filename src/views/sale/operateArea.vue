<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-select clearable style="width: 130px" class="filter-item" v-model="listQuery.importance" placeholder="运营区等级">
        <el-option v-for="item in importanceOptions" :key="item" :label="item" :value="item">
        </el-option>
      </el-select>
      <el-select clearable class="filter-item" style="width: 130px" v-model="listQuery.type" placeholder="运营区状态">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit
      ...
      <el-table-column prop="oaName" label="运营区名称" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="manageArea" label="管理区域" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="areaLevel" label="运营区等级" min-width="150" :formatter="areaLevel" align="center">
      </el-table-column>
      <el-table-column prop="status" label="状态" min-width="150" :formatter="status" align="center">
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      areaLevel: function(row, column) {
        return row.areaLevel == 11 ? '省' : row.areaLevel == 12 ? '市' : row.areaLevel == 14 ? '区/县' : '村/街道'
      },
