<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="oaName" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="manageArea" label="标题区" min-width="150" align="center">
      </el-table-column>
      <el-table-column prop="areaLevel" label="标题区" min-width="150" :formatter="areaLevel" align="center">
      </el-table-column>
      <el-table-column prop="status" label="标题区" min-width="150" :formatter="status" align="center">
      </el-table-column>
...
var datas = require("../../mock/falseData/6_operate/1_operateArea")
...
export default {
  ...
  // },
  methods: {
    areaLevel: function(row, column) {
      return row.areaLevel == 11
        ? "省"
        : row.areaLevel == 12
          ? "市"
          : row.areaLevel == 14 ? "区/县" : "村/街道"
    },
