	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0;">
			<el-form :inline="true" :model="filters" size="medium">
				...
				<el-form-item>
					<el-select v-model="filters.value1" placeholder="渠道">
						<el-option
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" border stripe fit size="mini" style="width: 100%;">
			...
			<el-table-column prop="channel" label="渠道" min-width="150" :formatter="channel">
			</el-table-column>
			<el-table-column label="操作" min-width="180" align="center">
				<template slot-scope="scope">
					...
					<el-button size="small" icon="circle-check" type="primary">删除</el-button>
