<template>
	<section>
		...
		<!--列表-->
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" border style="width: 100%;" stripe>
			<el-table-column type="selection" min-width="55">
			</el-table-column>
			<el-table-column prop="name" label="名称" min-width="256" sortable>
			</el-table-column>
			<el-table-column prop="sort" label="排序" min-width="128"  sortable>
			</el-table-column>
			<el-table-column prop="parentName" label="上级目录" min-width="230" sortable>
			</el-table-column>
