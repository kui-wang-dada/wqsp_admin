<template>
  <div class="form-container">
    <div class="form-content">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="140px" class="form-wraper">
        <el-form-item label="产品分类" prop="classify">
          <el-cascader :options="options" v-model="ruleForm.classify">
          </el-cascader>
        </el-form-item>
        ...
        <el-form-item label="规格" required>
          ...
          <div class="simple-grid">
            <el-table :data="tableData" stripe style="width: 100%">
              <el-table-column prop="quantity" label="规格">
              </el-table-column>
    ...
    <!-- 弹框 添加规格 -->
    <el-dialog title="添加规格" :visible.sync="dialogVisible" size="dl-small" :modal-append-to-body="false" :close-on-press-escape="false" :close-on-click-modal="false">
      <div class="add-quantity">
        <div class="quantity-content">
          <div class="list">
            <el-tag v-for="tag in tags" :key="tag.quantity" :closable="true" type="primary" @close="handleClose(tag)">
              {{tag.quantity}}
            </el-tag>
          </div>
...
.add-quantity .quantity-content .list {
  min-height: 80px;
  padding: 5px;
}
.add-quantity .quantity-content .list .el-tag {
  margin: 5px;
}
.add-quantity .quantity-content .input-control {
  height: 30px;
  line-height: 30px;
  padding: 10px;
}
.add-quantity .quantity-content .input-control input {
  display: block;
  line-height: 30px;
  border: none;
  outline: none;
}
.add-quantity .quantity-footer {
  height: auto;
  overflow: hidden;
  text-align: center;
}
