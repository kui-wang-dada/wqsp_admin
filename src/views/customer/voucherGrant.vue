  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('bill.filter.billNo')" v-model="listQuery.title">
      </el-input>
      <el-select clearable class="filter-item" style="width: 130px" v-model="listQuery.type"
                 :placeholder="$t('bill.filter.checkStatus')">
      ...
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('bill.filter.createName')" v-model="listQuery.title">
      </el-input>
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('bill.filter.updateName')" v-model="listQuery.title">
      </el-input>
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('bill.filter.startTime')" v-model="listQuery.title">
      </el-input>
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item"
                :placeholder="$t('bill.filter.endTime')" v-model="listQuery.title">
      </el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border stripe fit
      ...
      <el-table-column prop="title" label="代金券名称" align="center">
      </el-table-column>
      <el-table-column prop="oaName" label="运营区名称" align="center">
      </el-table-column>
      <el-table-column prop="address" label="状态" align="center">
      </el-table-column>
      <el-table-column prop="startDate" label="代金券开始日期" align="center">
      </el-table-column>
      <el-table-column prop="endDate" label="代金券结束日期" align="center">
      </el-table-column>
      <el-table-column prop="shareRateSelf" label="平台分摊比例" align="center">
      </el-table-column>
      <el-table-column prop="shareRateThird" label="第三方分摊比例" align="center">
      </el-table-column>
      <el-table-column prop="merchantName" label="第三方商户名称" align="center">
      </el-table-column>
      <el-table-column prop="useRange" label="使用范围" align="center">
      </el-table-column>
      <el-table-column prop="useDays" label="使用天数" align="center">
      </el-table-column>
      <el-table-column prop="delayUseDays" label="推迟使用天数" align="center">
      </el-table-column>
      <el-table-column prop="conditionAmount" label="满减达到金额" align="center">
      </el-table-column>
      <el-table-column prop="giftAmount" label="减免金额" align="center">
      </el-table-column>
