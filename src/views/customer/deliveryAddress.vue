<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" border stripe fit size="mini" style="width: 100%;">
			...
			<el-table-column prop="linkMan" label="联系人" min-width="150">
			</el-table-column>
			<el-table-column prop="contactNum" label="联系电话" min-width="150">
			</el-table-column>
			<el-table-column prop="address" label="详细地址" min-width="150">
			</el-table-column>
			<el-table-column prop="isDefault" label="是否默认" min-width="150" :formatter="isDefault">
			</el-table-column>
