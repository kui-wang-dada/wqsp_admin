<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="oaName" label="标题区" width="180" align="center">
      </el-table-column>
      <el-table-column prop="wmsName" label="标题区" width="180" align="center">
      </el-table-column>
      <el-table-column prop="status" label="标题区" width="200" :formatter="formatsta" align="center">
      </el-table-column>
      <el-table-column prop="delFlag" label="标题区" width="180" :formatter="formatdel" align="center">
      </el-table-column>
      <el-table-column label="标题区" min-width="240" align="center">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
        <el-form-item label="标题区" prop="type">
          <el-select class="filter-item" v-model="temp.type" placeholder="标题区">
...
var opera = require("../../mock/falseData/operate_12/opera")
