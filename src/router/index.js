...
export const constantRouterMap = [
  ...
  { path: '/401', component: _import('errorPage/401'), hidden: true },
  {
    ...
    children: [
      { path: 'premiss', component: _import('premiss/Permiss'), name: 'premiss', meta: { title: '权限管理', icon: 'pre-quan' }, children: [], noCache: true
      },
      // { path: 'add', component: _import('premiss/add/addform'), name: 'add', meta: { title: '权限修改', icon: 'pre-jiao' }, hidden: true },
